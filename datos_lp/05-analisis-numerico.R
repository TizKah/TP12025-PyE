...
summary(porcentaje_de_aumento_de_alquiler)
...
round(sd(porcentaje_de_aumento_de_alquiler, na.rm = TRUE)/mean(porcentaje_de_aumento_de_alquiler, na.rm = TRUE)*100,2) # Coeficiente de variación
...
round(sd(núm_integrantes, na.rm = TRUE)/mean(núm_integrantes, na.rm = TRUE)*100,2) # Coeficiente de variación
